...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Experiment{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner Experiment
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1alpha1.Experiment{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileExperiment) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &appv1alpha1.Experiment{}
	...
	// Set Experiment instance as the owner and controller
...
func newPodForCR(cr *appv1alpha1.Experiment) *corev1.Pod {
