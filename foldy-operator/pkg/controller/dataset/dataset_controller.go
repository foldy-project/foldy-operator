...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Dataset{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileDataset) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Dataset instance as the owner and controller
...
func newPodForCR(cr *appv1alpha1.Dataset) *corev1.Pod {
